...
public class BankStateReponse   {
    ...
    public BankStateReponse() {
    }

    public BankStateReponse(Long id, Double spent,   Double gain,   Double virtualBank,  Double realBank,  Date dateState) {
        this.id = id;
        this.spent = spent;
        this.gain = gain;
