...
import com.yemmback.store.payload.reponse.PagedResponse;
import com.yemmback.store.payload.reponse.PollResponse;
import com.yemmback.store.payload.request.PollRequest;
import com.yemmback.store.payload.request.VoteRequest;
import  com.yemmback.store.repository.PollRepository;
import  com.yemmback.store.repository.UserRepository;
import  com.yemmback.store.repository.VoteRepository;
import  com.yemmback.store.security.UserPrincipal;
import  com.yemmback.store.util.AppConstants;
import com.yemmback.store.util.ModelMapper;
...
public class PollService {
    ...
    private static final Logger logger = LoggerFactory.getLogger( com.yemmback.store.service.PollService.class);
